export const Tours=()=>{
    return  <section class="section" id="tours">
      ...
      <div class="section-center featured-center">
        <article class="tour-card">
          <div class="tour-img-container">
            <img src="./public/tour-1.jpeg" class="tour-img" alt="" />
        ...
        <article class="tour-card">
          <div class="tour-img-container">
            <img src="./public/tour-2.jpeg" class="tour-img" alt="" />
        ...
        <article class="tour-card">
          <div class="tour-img-container">
            <img src="./public/tour-3.jpeg" class="tour-img" alt="" />
        ...
        <article class="tour-card">
          <div class="tour-img-container">
            <img src="./public/tour-4.jpeg" class="tour-img" alt="" />
